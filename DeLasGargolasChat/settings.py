"""
Django settings for DeLasGargolasChat project.
...
if getattr(sys, 'frozen', False):
    # If running from a PyInstaller executable, use the dir where the .exe is.
...
CSRF_TRUSTED_ORIGINS = [
    'https://delasgargolaschat-8wsw.onrender.com',
    'http://localhost:8000',
    'http://127.0.0.1:8000',
]
...
ROOT_URLCONF = 'DeLasGargolasChat.urls'
...
WSGI_APPLICATION = 'DeLasGargolasChat.wsgi.application'
ASGI_APPLICATION = 'DeLasGargolasChat.asgi.application'
